angular.module('bike.controllers').controller('BikeCtrl', ['$scope', '$http', '$routeParams', '$location','Bike', 'FilterService', 'BikeImages','$resource', function($scope, $http, $routeParams, $location, Bike, FilterService, BikeImages, $resource){
