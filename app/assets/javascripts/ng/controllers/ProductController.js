angular.module('product.controllers').controller('ProductCtrl', ['$scope', '$http', '$routeParams', '$location','Product', 'FilterService', 'BikeImages','$resource', function($scope, $http, $routeParams, $location, Bike, FilterService, BikeImages, $resource){

  Product.smartQuery(function(bikes) {
    $scope.bikes = bikes;
  });
